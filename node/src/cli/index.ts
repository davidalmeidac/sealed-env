...
function helpCommand(): void {
  process.stdout.write(
    [
      ...
      '',
      '  doctor --remediate',
      '      Offer to remove the persistence markers doctor found. Copies each',
      '      file into .sealed-env-quarantine/ before deleting it, and asks for',
      '      confirmation first. Config files that legitimate tooling also owns',
      '      (.vscode/tasks.json, .claude/settings.json) are never auto-removed.',
      '',
